...
<body>
    ...
    <div class="video">
        <h2 class="titulo">VIDEO TUTORIAL PARA EL ARROZ CON POLLO</h1>
    ...
    ?>
        ...
        <div class="descripcionArrozconPollo">
            <p>El arroz con pollo es un plato emblemático de la gastronomía colombiana que combina ingredientes simples pero sabrosos para crear una comida reconfortante y deliciosa. Es una preparación popular en todo el país y se pueden encontrar variaciones regionales que le añaden un toque único.</p>
        </div>
