...
<body>
    ...
    <div class="video">
        <h2 class="titulo">VIDEO TUTORIAL PARA EL SANCOCHO</h1>
    ...
    ?>
        ...
        <div class="descripcionSancocho">
            <p>El sancocho colombiano es un plato tradicional y reconfortante que se disfruta en toda Colombia, siendo especialmente popular en las zonas rurales y durante celebraciones familiares. Se trata de una sopa abundante y nutritiva que combina una variedad de ingredientes, como carne, tubérculos, verduras y especias, cocidos a fuego lento para desarrollar sabores profundos y complejos.</p>
        </div>
