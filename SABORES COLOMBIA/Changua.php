...
<body>
    ...
    <div class="video">
        <h2 class="titulo">VIDEO TUTORIAL PARA LA CHANGUA</h1>
    ...
    ?>
        ...
        <div class="descripcionChangua">
            <p>La changua es una tradicional sopa colombiana, especialmente popular en la región de Cundinamarca y Boyacá, aunque también se disfruta en otras partes del país. Se destaca por su sencillez en ingredientes y su sabor reconfortante, convirtiéndola en una opción popular para el desayuno o como comida reconfortante en días frescos.</p>
        </div>
