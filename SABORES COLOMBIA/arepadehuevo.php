...
<body>
    ...
    <div class="video">
        <h2 class="titulo">VIDEO TUTORIAL PARA LA AREPA DE HUEVO</h1>
    ...
    ?>
        ...
        <div class="descripcionArepaHuevo">
            <p>La arepa de huevo colombiana es una deliciosa y popular especialidad de la región caribeña de Colombia. Se trata de una arepa rellena de huevo que se fríe hasta que queda dorada y crujiente por fuera, mientras que el huevo en su interior queda cocido pero con la yema aún suave.</p>
        </div>
